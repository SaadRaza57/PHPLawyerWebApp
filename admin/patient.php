    ...
    <div class="main-wrapper">
        <div class="header">
			<div class="header-left">
				<a href="" class="logo">
					<img src="img/logo.png" width="35" height="35" alt=""> <span>Care</span>
				</a>
			</div>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
							...
							<ul style="display: none;">
								<li><a href="doctor-profile.php">Patient Profile</a></li>
								<!-- <li><a href="leaves.html"></a>Add Doctor</li> -->
								<li><a href="holidays.html">View patients</a></li>
							</ul>
						</li>
                        <!-- <li>
