...
<body>
    ...
    <?php 
        ...
        <div class="page-wrapper">
            <div class="content">
                <h2 style="text-align: center;">Add New Lawyer</h2><br><br>
                <form method="post" id="form">
                    <input type="text" placeholder="Lawyer Name" name="txtname"> <br><br>
                    <input type="text" placeholder="Lawyer Email" name="txtemail"> <br><br>
                    <input type="text" placeholder="Lawyer Phone" name="txtphone"> <br><br>
                    <input type="text" placeholder="Lawyer Username" name="txtusername"> <br><br>
                    <input type="text" placeholder="Lawyer Password" name="txtpassword"> <br><br>
                    <input type="text" placeholder="Consult Charges" name="txtcharges"> <br><br>
                    ...
                    <input type="submit" value="Insert Lawyer" name="btninsert" class="update">
                </form>
                <?php
                    if(isset($_POST['btninsert']))
                    {
                        ...
                        $insert_query = "INSERT INTO tbl_lawyer(d_name,d_email,d_phone,d_username,d_password,specialization,city_id,consult_charges) VALUES('$dname','$demail','$dphone','$dusername','$dpassword','$dspecialization','$cityid','$dcharges')";
