...
<body>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="height: 100vh; min-height: 400px;">
                    <img class="position-absolute w-100 h-100" src="img/lawyerlogo/carousel-1.jpg" style="object-fit: cover;">
                ...
                <div class="carousel-item position-relative" style="height: 100vh; min-height: 400px;">
                    <img class="position-absolute w-100 h-100" src="img/lawyerlogo/carousel-2.jpg" style="object-fit: cover;">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-5">
                    <img class="img-fluid rounded" src="img/LAW.webp" alt="">
                </div>
                <div class="col-lg-7 mt-4 mt-lg-0">
                    <h2 class="position-relative text-center bg-white text-primary rounded p-3 mt-4 mb-4 d-none d-lg-block" style="width: 350px; margin-left: -205px;">What is Law?</h2>
                    <p>Law is a set of rules that are created and are enforceable by social or governmental institutions to regulate behavior, with its precise definition a matter of longstanding debate. It has been variously described as a science and as the art of justice. State-enforced laws can be made by a group legislature or by a single legislator, resulting in statutes; by the executive through decrees and regulations; or established by judges through precedent, usually in common law jurisdictions. Private individuals may create legally binding contracts, including arbitration agreements that adopt alternative ways of resolving disputes to standard court litigation.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="img/lawyerlogo/feature.jpg" style="object-fit: cover;">
                    </div>
                </div>
                    ...
                    <div class="feature-text bg-white rounded p-lg-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="m-0">Our practices speaks for itself. Our in-house lawyers are fully capable of Pakistani laws and can assist you in your case.</p>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="btn-primary btn-lg-square px-3" style="border-radius: 50px;">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="m-0">Speed and efficiency are the key element in today's fast-paced world. Trust is critical for effective leadership. We are a be-spoke law firm.</p>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="btn-primary btn-lg-square px-3" style="border-radius: 50px;">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="m-0">If you or family and friends experiences an individual physical issue, the impacts can be devastating. The financial and emotional issues can flip around lives in a moment.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        foreach($fetch_doctors as $doctor)
                        {
                            ...
                            <div class='team-item'>
                                <div class='position-relative rounded-top' style='z-index: 1;'>
                                    <img class='img-fluid rounded-top w-100' src='../lawyer/$doctor[d_image]'>
                                </div>
    ...
    <div class="container-fluid bg-secondary text-white pt-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>We specialized in Civil, Criminal, Corporate, Tax, Banking, & Services Matters.</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>Signup for the newsletter and get fresh news and commentary on the Pakistani laws.</p>
                <div class="w-100">
